...
const studentsReducer = (state = [], action) => {
  switch(action.type) {
    ...
    case UPDATE_STUDENT:
      ...
      break;
    case DELETE_STUDENT:
      state = state.filter(student => student.id !== action.student.id ? action.student : student);
      break;
    case CREATE_STUDENT:
...
const campusReducer = (state = [], action) => {
  switch(action.type) {
    case SET_CAMPUSES:
      ...
      break;
    case DELETE_CAMPUS:
      state = state.filter(campus => campus.id !== action.campus.id ? action.campus : campus);
      break;
    case CREATE_CAMPUS:
...
export { loadStudents, loadCampuses, saveStudent, deleteStudent, saveCampus, deleteCampus };
